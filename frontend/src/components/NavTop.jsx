          ...
          <Row lg='auto' className='d-flex justify-content-end'>
            ...
            <Col lg='auto'>
              <Row lg={12} className='d-flex text-center justify-content-between'>
                {/* about */}
                <Col lg='auto' md={5} sm={5} xs={5} className='navbar-label navbar-upper-imp'>
                  <Link to='/about'>
                    {aboutNavMenuLabel}
                  </Link>
                </Col>
                ...
                {/* blog */}
                <Col lg='auto' md={5} sm={5} xs={5} className='navbar-label navbar-upper-imp navbar-upper-blog' >
                  <Link to='/blog'>
                    {blogNavMenuLabel}
                  </Link>
                </Col>
