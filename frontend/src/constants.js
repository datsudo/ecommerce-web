...
export const aboutNavMenuLabel = ( <> <FontAwesomeIcon className="mt-1 pe-1" icon={faPeopleGroup} /> About </> )
export const blogNavMenuLabel = ( <> <FontAwesomeIcon className='mt-1 pe-1' icon={faNewspaper} /> Blog </> )
